...
public class Fragment_Yusuan extends Fragment {
	...
	private void showNumPickerDialog(final int pos, final String type) {
		...
		Button decimal = (Button) window.findViewById(R.id.decimal);
		Button digit_1 = (Button) window.findViewById(R.id.digit_1);
		Button digit_2 = (Button) window.findViewById(R.id.digit_2);
		Button digit_3 = (Button) window.findViewById(R.id.digit_3);
		Button digit_4 = (Button) window.findViewById(R.id.digit_4);
		Button digit_5 = (Button) window.findViewById(R.id.digit_5);
		Button digit_6 = (Button) window.findViewById(R.id.digit_6);
		Button digit_7 = (Button) window.findViewById(R.id.digit_7);
		Button digit_8 = (Button) window.findViewById(R.id.digit_8);
		Button digit_9 = (Button) window.findViewById(R.id.digit_9);
		Button digit_0 = (Button) window.findViewById(R.id.digit_0);
		setFontType(decimal, digit_1, digit_2, digit_3, digit_4, digit_5,
				digit_6, digit_7, digit_8, digit_9, digit_0);
		Button btn_dia_cacle = (Button) window.findViewById(R.id.btn_dia_cacle);
		Button btn_dia_ok = (Button) window.findViewById(R.id.btn_dia_ok);
	...
	private void btnClick(final int pos, final EditText tv_title,
			Button delete, Button decimal, Button digit_1, Button digit_2,
			Button digit_3, Button digit_4, Button digit_5, Button digit_6,
			Button digit_7, Button digit_8, Button digit_9, Button digit_0,
			Button btn_dia_ok, final String type) {
	...
	private void setFontType(Button decimal, Button digit_1, Button digit_2,
			Button digit_3, Button digit_4, Button digit_5, Button digit_6,
			Button digit_7, Button digit_8, Button digit_9, Button digit_0) {
